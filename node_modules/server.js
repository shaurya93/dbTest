...
// insert or update IR  and IR lines
	 for(var i=0;i<results.itemreceiptdetails.length;i++)
	{
		...
		{
			var update_query= "update item_receipt set ns_ext_id='" + results.itemreceiptdetails[i].tranID
			...
			for(var j=0;j<results.itemreceiptdetails[i].itempush.length;j++)
			{
				...
				*/
				...
				{
					var update_query = "update item_receipt_lines set item_id='" + results.itemreceiptdetails[i].itempush[j].item_id
