...
if(req.query.vendorid)
{
	...
	dbs.db('POSTGRESS');
	console.log(" in server after DB call ");
...
if(id)
{
	...
	timestamp_contents.on("row",function(row){
	rows.push(row);
	//result.addRow(row);
	...
	time_stamp = result.rows[0].localtime;
	//console.log(time_stamp);
	//console.log('Getting TimeStamp'+JSON.stringify(result.rows, null, "    "));
	...
	console.log("status is all orders");
		{
			...
			contents.on("row",function(row){
			rows.push(row);
			//fired once for each row returned
			});
			
			contents.on("end", function (result) {          
			contents_length=result.rowCount;
			console.log('contents_length :: ' + contents_length);
...
else
{
			...
			contents_length=result.rowCount;
			console.log('contents_length :: ' + contents_length);
			results = JSON.stringify(result.rows1[0]);
			console.log('result :: ' + results);
			});
...
console.log("contents  "+JSON.stringify(contents));
	...
	if(contents != '')
	{
		//console.log("contents length : "+contents[0]["values"].length);
		//for (var i=0; i<contents[0]["values"].length; i++) 
	//console.log('Result contents :: '+ JSON.stringify(result))
  ...
  res.render('postatusview', { //render the index.ejs
	  ...
	  contentlength:contents_length
	  
  });
	}
	else
	{
		console.log('If contents null');
