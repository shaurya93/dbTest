...
if(id)
{
	...
	console.log('post of vendor create');
	var
	var
	var
	var
		...
		if(req.query.shipping_point)
		{
			...
			var shipment_point_val = req.body.shipping_point;
		}
		if(req.query.modes)
		{
			console.log("Delivery Method--> "+ req.body.modes);
			var delivery_method_val = req.body.modes;
		}
			console.log("Currency -->" + req.body.currency);
			var currency_val = req.body.currency;
			console.log("Company Name -->" + req.body.company_name );
			var company_name_val = req.body.company_name;
		
		if(req.query.deliveryleadtime)
		{
		console.log("Delivery Lead Time -->" + req.body.deliveryleadtime);
		var delivery_lead_time_val = req.body.deliveryleadtime;
		}
		if(req.query.exfactoryleadtime)
		{
		console.log("Ex-factory Lead Time -->" + req.body.exfactoryleadtime);
		var exfactory_lead_time_val = req.body.exfactoryleadtime;
		}
		if(req.query.)
		{
		...
		if(req.query.)
		{
		console.log("In CoTerms -->" + req.body.incoterm);
		var incoterm_val = req.body.incoterm;
		}
		if(req.query.)
		{
		console.log("Security Question -->" + req.body.security_question);
		...
		var phone_val = req.query.phone;
		}
		if(req.query.)
		{
		console.log("Address -->" + req.query.address);
		var address_val = req.query.address;
		}
		console.log("Password -->" + req.query.password);
		var password_val = req.query.password;
		if(req.query.)
		{
		console.log("Alt-Phone -->" + req.query.altphone);
		var altphone_val = req.query.altphone;
		}
		if(req.query.)
		{
		console.log("Fax -->" + req.query.fax);
		var fax_val = req.query.fax;
		}
		if(req.body.first_name||req.body.last_name)
		{
			...
			if(req.query.contact_person)
			{
				...
				var contact_name_val = req.query.contact_person;
			}
			if(req.query.)
			{
				console.log("Contact Phone -->" + req.query.con_number);
				var contact_phone_val = req.query.con_number;
			}
			
			var rest_params = {event:"refresh",email:email,password:passwordval};
		}
		else
		{}
		...
		{
			console.log("Contact Name -->" + req.query.contact_name);
			var contact_name_val = req.query.contact_name;
			console.log("Contact Email -->" + req.query.contact_email);
			var contact_email_val = req.query.contact_email;
			console.log("Contact Phone -->" + req.query.contact_phone);
			var contact_phone_val = req.query.contact_phone;
			var rest_params = {event:"refresh",email:email,password:passwordval};
		}
		else
		{
			console.log("First Name -->" + req.body.first_name);
			var firstname_val = req.body.first_name;
			console.log("Last Name -->" + req.body.last_name);
			var lastname_val = req.body.last_name;
			var rest_params = {event:"refresh",email:email_val,password:confirm_password_val};
		}
...
app.get('/d3', function(req, res, next) { // route for '/'
	...
	*/	
	...
	dbs.readData(function (result){
		...
		console.log("result length : "+plChild);
		
		}
		

	res.render('d3',{
		tran_PackingList:plChild
	});
});
	  }
else
