...
app.get('/d3', function(req, res, next) { // route for '/'
	...
	*/	
	...
	dbs.readData(function (result){
		...
		poParent.push({name:"Purchase Order",assigned:"Purchase Order::5172",children:plChild});
		console.log("poParent : "+JSON.stringify(poParent[0]));
		//poParent = poParent.Replace("\", "");
		var obj = jQuery.parseJSON(JSON.stringify(poParent[0]));
		console.log("after poParent : "+obj);
		res.render('d3',{
			tran_po:obj
		});
});
