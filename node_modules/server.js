...
app.get('/login', function(req,res,next){
	...
	*/
	...
	var query9 = "Update table \"timestamp\" set rec_type = 'ItemReceipt',timestamp='06/01/2016 10:15 PM',local_time='06/02/2016 10:45:16',vendor_ns_id'1413' where rec_type = 'ItemReceipt')";
		var f9 = {query:query9};
		dbs.query(null,f9);
		dbs.update();
...
{
	setTimeout(function () {
           res.redirect(303,'/ItemReceiptsView?bill_ns_id='+billid);
        }, 5000);
