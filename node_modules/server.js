...
app.post('/vendorcreate',function(req,res){
...
/*
	...
	*/	
	console.log("result length :: "+result.length);
	console.log("json_PO length :: "+json_PO.length);
	if(json_PO!=null)
	{
		console.log("json_PO length : "+json_PO.length);
		var json_PO_data = new Array();
	
		for (var i=0; i<json_PO.length; i++) 
		{
		var item = new Object();
		
		item.po_ns_id_val= json_PO[i].po_ns_id;
		console.log("item.po_ns_id_val  "+item.po_ns_id_val);
		
		item.po_number = json_PO[i].po_number; 
		/*item.bill_ns_id_val = result[i].bill_list_ns_id;
		item.quantity_val = result[i].quantity;
		item.amount_val = result[i].amount; 
		item.tax_amt_val = result[i].tax_amount;*/ 
		json_PO_data.push(item);
		
		}  
	
	
	
	console.log("json_PO_data "+items_data);
	console.log("json_PO_data "+JSON.stringify(json_PO_data));
