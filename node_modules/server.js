...
if(id)
{
	...
	console.log('post of vendor create');
		...
		var shipment_origin_val = req.body.shipmentorigin;
		console.log("Shipment Point  -->" + req.body.shippingpoint);
		var shipment_point_val = req.body.shippingpoint;
		console.log("Delivery Method--> "+ req.body.deliverymethod);
		var delivery_method_val = req.body.deliverymethod;
...
app.get('/d3', function(req, res, next) { // route for '/'
	...
	*/	
	...
	dbs.query(null,fields_query_json_PackingList);
	dbs.readDirectData(function (result){
		json_PackingList = result;
		console.log("result :: "+ result);
		console.log("json_PackingList :: "+ JSON.stringify(json_PackingList));
		...
		for (var i=0; i<result.length; i++) 
		{
			...
			plChild[i].push({name:"Packing List",assigned:"Packing List::"+pl_id[i],date:pl_date[i],status:pl_status[i]});
