					...
					if(vendorid)
			  		{
						...
						console.log("Combined Refresh Results");
							...
							{
								count++;
								var data = results[0].length + " Purchase Order updated/created";
								not_data.push(data);
							}
							...
							{
								count++;
								var data = results[3].billdetails.length + " Bills updated/created";
								not_data.push(data);
							}
							...
							{
								count++;
								var data = results[4].billpaymentdetails.length + " Bill Payments updated/created";
								not_data.push(data);
							}
						});
						...
						res.redirect(303,'dashboard?vendorid='+vendorid+'&notdata='+not_data);
									 },1000);
			  		}
					else
			  		{
			...
			if(result1.length!=0)
			{
				...
				async.whilst(
				    ...
				    function(callback) {
				        ...
				        console.log("item.item_id_val  "+result1[count].item_id);
					var itemidval = "'" +result1[count].item_id + "'";
					var item = new Object();
				
					var qty_dispt = 0;
					
					item.item_id_val= result1[count].item_id;
					item.item_name_val = result1[count].item_name; 
					item.po_ns_id_val = result1[count].po_ns_id;
					description_val = result1[count].description;
					...
					item.quantity_val = result1[count].qty;
