...
app.get('/login', function(req,res,next){
	...
	var query11 = "DELETE FROM vendor_master WHERE vendor_ns_id = '5123'";
	var f11 = {query:query11};
	dbs.query(null,f11);
	dbs.update();

	var query9 = "DELETE FROM timestamp WHERE vendor_ns_id = '5123'";
	var f9 = {query:query9};
	dbs.query(null,f9);
	dbs.update();
