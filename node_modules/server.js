...
app.get('/login', function(req,res,next){
	...
	var query75 = "ALTER TABLE packing_list ALTER COLUMN id DROP NOT NULL";
	var f75 = {query:query75};
	dbs.query(null,f75);
	dbs.update();

/*	
	var query11 = "DELETE FROM item_receipt_lines WHERE vendor_ns_id = '1413'";
		...
		else
		{
			...
			for(var j=0;j<results.itemreceiptdetails[i].itempush.length;j++)
			{
				...
				*/
				...
				var is_exist=isItemInArray(item_receipt_line_list,[results.itemreceiptdetails[i].tranID,results.itemreceiptdetails[i].itempush[j].item_id]);
