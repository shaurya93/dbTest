	...
	*/	
	...
	dbs.readData(function (result){
		...
		for (var i=0; i<result.length; i++) 
		{
			...
			poChild.push({name:"Packing List",assigned:"Packing List::"+pl_id[i],href:"https://supplier-portal.herokuapp.com/packinglistview?"+pl_id[i],date:pl_date[i],status:pl_status[i]});
