...
app.get('/d3', function(req, res, next) { // route for '/'
	...
	*/	
	...
	var fields_ItemReceiptContents= {key:"po_ns_id",operator:"=",value:'5172',key1:"VENDOR_NS_ID::integer",operator1:"=",value1:id};
	dbs.query('packing_list',fields_ItemReceiptContents);
	dbs.readData(function (result){
		...
		for (var i=0; i<result.length; i++) 
		{
			ir_id[i] = result[i].packing_list_ns_id; 
			ir_status[i] =result[i].status;
			ir_date[i]= result[i].date_created;
			poChild.push({name:"Item Receipt",assigned:"Item Receipt::"+ir_id[i],date:ir_date[i],status:ir_status[i]});
	...
	var fields_VendorBillContents= {key:"po_ns_id",operator:"=",value:'5172',key1:"VENDOR_NS_ID::integer",operator1:"=",value1:id};
	dbs.query('packing_list',fields_VendorBillContents);
	dbs.readData(function (result){
		...
		for (var i=0; i<result.length; i++) 
		{
			vb_id[i] = result[i].packing_list_ns_id; 
			vb_status[i] =result[i].status;
			vb_date[i]= result[i].date_created;
			poChild.push({name:"Vendor Bill",assigned:"Vendor Bill::"+vb_id[i],date:vb_date[i],status:vb_status[i],children:poChild});
