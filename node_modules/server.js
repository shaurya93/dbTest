...
/*POST Vendor Create Company Page. */
app.post('/vendorcreatecompany',function(req,res){
...
/*POST Vendor Create Individual Page. */
app.post('/vendorcreateindividual',function(req,res){
