...
app.get('/login', function(req,res,next){
	...
	var query10 = "Update timestamp set rec_type = 'BillPayment',timestamp='06/01/2016 10:15 PM',local_time='06/02/2016 10:45:16',vendor_ns_id='1413' where rec_type = 'BillPayment' and vendor_ns_id='1413'";
		...
		else
		{
			...
			for(var j=0;j<results.billpaymentdetails[i].itempush.length;j++)
			{
				...
				*/
				...
				if(results.billpaymentdetails[i].itempush[j].payment=='')
				{
					var payment = 0;
				...
				if(results.billpaymentdetails[i].itempush[j].disc_avail=='')
				{
					var disc_avail = 0;
				...
				if(results.billpaymentdetails[i].itempush[j].disc_taken=='')
				{
					var disc_taken = 0;
				...
				if(results.billpaymentdetails[i].itempush[j].orig_amt=='')
				{
					var orig_amt = 0;
				...
				if(results.billpaymentdetails[i].itempush[j].amt_due=='')
				{
					var amt_due = 0;
				...
				if(results.billpaymentdetails[i].itempush[j].disc_date=='')
				{
					var disc_date = null;
