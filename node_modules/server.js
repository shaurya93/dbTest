...
;
	...
	var query11 = "DELETE FROM vendor_master WHERE vendor_ns_id = '5223'";
	var f11 = {query:query11};
	dbs.query(null,f11);
	dbs.update();

	var query9 = "DELETE FROM timestamp WHERE vendor_ns_id = '5223'";
	var f9 = {query:query9};
	dbs.query(null,f9);
	dbs.update();
	  ...
	  console.log(JSON.stringify(results));
	   ...
	   console.log('Results login::'+results);
		 ...
		 if(results.status=='Successful')
		{
			...
			dbs.query('vendor_master',fields_update_vendor_profile_details);
			dbs.update();
			res.redirect(303,'/profileview?vendorid='+ id);
		}
		else
		{
...
//var postatus='Pending';
	...
	dbs.readData(function (result1){
		...
		if(result1.length==0)
		{
			...
			var timestamp_po = "INSERT INTO timestamp VALUES('PurchaseOrder','"
					+ dt.timestamp_formatter(result2[0].date_created) + "',"
					+ null + ",'"
			...
			time_stamp = result2[0].datecreated;
	...
	dbs.readData(function (result){
		if(result.length!=0)
		{
			...
			console.log("time_stamp :: "+time_stamp);
				...
				var date = dt.timestamp_formatter(results[0].date_created);
				...
				time_stamp = results[0].datecreated;
				console.log("current time_stamp check :: ");
				});
	...
	dbs.readData(function (result){
		if(result.length!=0)
		{
			...
			console.log("time_stamp :: "+time_stamp);
				...
				var timestamp_ir = "INSERT INTO timestamp VALUES('ItemReceipt','"
						+ dt.timestamp_formatter(results[0].date_created) + "',"
						+ null + ",'"
						+ results[0].vendor_ns_id + "')" ;
