...
app.get('/d3', function(req, res, next) { // route for '/'
	...
	var fields_ItemReceiptContents= {key:"purchase_order_id::integer",operator:"=",value:po_id,key1:"VENDOR_NS_ID::integer",operator1:"=",value1:id};
	dbs.query('Item_Receipt',fields_ItemReceiptContents);
	dbs.readData(function (result){
		if(result!=''){
			console.log("Item Receipts result::  "+JSON.stringify(result));
			for (var i=0; i<result.length; i++){
