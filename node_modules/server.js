...
if(req.query.vendorid)
{
	...
	client.connect();
	var contents = client.query("select * from vendor_master where VENDOR_NS_ID="+id+"::varchar");
 ...
 var contents='';		
			...
			if(results.status=='Successful')
			{
				...
				var conString = process.env.DATABASE_URL ;
        			...
        			client.connect();
        			var contents = 
        			client.query("select * from vendor_master where vendor_ns_id::integer="+vendorid).on('row', function(row,result)
        			{
        				result.addRow(row);
