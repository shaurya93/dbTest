...
if(req.query.vendorid)
{
	...
	client.connect();
	contents;
	var results = client.query("select * from vendor_master where VENDOR_NS_ID::integer="+id);
	results.on("row", function(row,result)
        {
        	result.addRow(row);
	...
	contents_po_all_count= client.query("select * from purchase_order");;
	...
	{
		po_all_count = contents_po_all_count[0].length;
	}
	...
	{
		po_pendingAck_count = contents_po_pendingAck_count[0].length;
	}
	...
	{
		po_Ack_count = contents_po_Ack_count[0].length;
	}
	...
	{
		po_pendingDelivery_count = contents_po_pendingDelivery_count[0].length;
	}
	...
	{
		po_pendingBill_count = contents_po_pendingBill_count[0].length;
	}
	...
	{		
		po_fully_billed_count = contents_po_fully_billed_count[0].length;		
	}		
	...
	{
		pl_readyToShip_count = contents_pl_readyToShip_count[0].length;
	}
	...
	{
		pl_shipped_count = contents_pl_shipped_count[0].length;
	}
	...
	{
		bill_all_count = contents_bill_all_count[0].length;
	}
