...
app.use(function(req,res,next){
	if(req.session && req.session.user){
		console.log('req.session.user.vendor_ns_id  -->' + req.session.user[vendor_ns_id] );
		console.log('req.session.user --> ' + req.session.user);
		console.log('Json Format req.session.user -->' + JSON.stringify(req.session.user));
		var fields_vendor_login= {key:"vendor_ns_id::integer",operator:"=",value:req.session.user.vendor_ns_id};
...
// trigger the restlet
				...
				console.log("bill Payment netsuite id : "+results.billpaymentdetails[0].itempush[0].bill_ns_id);
				console.log("timestamp : "+results.updatetimestamp);
	...
	dbs.readData(function (result1){
		...
		if(result1!=null)
		{
			...
			for(var r=0;r<result1.length; r++) 
			{
				...
				//bill_payment_line_list[r][1]=result1[r].item_id;
		...
		else
		{
			...
			for(var j=0;j<results.billpaymentdetails[i].itempush.length;j++)
			{
				...
				*/
				...
				var is_exist=isItemInArray(item_receipt_list,[results.billpaymentdetails[i].tranID,results.billpaymentdetails[i].itempush[j].item_id]);
...
app.get('/billpaymentsview', function(req, res, next) {
