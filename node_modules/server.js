		...
		dbs.readData(function (result1){
			if(result1.length!=0)
			{
				...
				for (var i=0; i<result1.length; i++) 
				{
					...
					console.log("item.item_id_val  "+item[i].item_id_val);
					var itemidval = "'" + item[i].item_id_val + "'";
					...
					console.log(" item.quantity_val"+item[i].quantity_val);
					...
					dbs.readData(function (result2){
						...
						if(result2.length!=0)
						{
							...
							console.log("Item being Inserted and qty dispt being checked inside if" + item[i]);
							...
							if(qty_dispt < item[i].quantity_val)
							{
								item[i].disp_qty = qty_dispt;
								items_data.push(item[i]);
								console.log(" data pushed in item list "+ i + " Item inserted if PL already exists " +JSON.stringify(items_data));
							}
						}
						else
						{
							console.log("Item being Inserted and qty dispt being checked inside else" + item[i]);
							item[i].disp_qty = qty_dispt;
							items_data.push(item[i]);
