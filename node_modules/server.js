	  ...
	  console.log(JSON.stringify(results));
	   ...
	   console.log('Results login::'+results);
		 ...
		 if(results.status=='Successful')
		{
			...
			dbs.query('vendor_master',fields_update_vendor_profile_details);
			dbs.update();
			res.redirect(303,'/profileview?vendorid='+ id+'&notdata[]='+not_data+'&count='+count);
		}
		else
		{
			res.redirect(303,'/dashboard?notdata[]='+not_data+'&count='+count);
		} 
 ...
 if(results.status!='fail')		
{
  ...
  var data_len=results.podetails.length;
	count = data_len;
	var newnotf = data_len + " Purchase Order added /created";
...
{
	setTimeout(function () {
           res.redirect(303,'/postatusview?po_status='+postatus+'&notdata[]='+not_data+'&count='+count);
        }, 5000);
...
{
	setTimeout(function () {
           res.redirect(303,'/poview?po_ns_id='+poid+'&notdata[]='+not_data+'&count='+count);
        }, 5000);
...
{
	setTimeout(function () {
           res.redirect(303,'/billlistview?&notdata[]='+not_data+'&count='+count);
        }, 5000);
...
{
	setTimeout(function () {
           res.redirect(303,'/billview?bill_ns_id='+billid+'&notdata[]='+not_data+'&count='+count);
        }, 5000);
...
{
	setTimeout(function () {
           res.redirect(303,'/billpayments?notdata[]='+not_data+'&count='+count);
        }, 5000);
...
{
	setTimeout(function () {
           res.redirect(303,'/billpaymentsview?bill_payment_ns_id='+bill_payment_ns_id+'&notdata[]='+not_data+'&count='+count);
        }, 5000);
...
{
	setTimeout(function () {
           res.redirect(303,'/ItemReceipts?notdata[]='+not_data+'&count='+count);
        }, 5000);
...
{
	setTimeout(function () {
           res.redirect(303,'/ItemReceiptsView?ns_id='+item_receipt_ns_id+'&notdata[]='+not_data+'&count='+count);
        }, 5000);
...
if(id)
{
	...
	*/
	setTimeout(function () {
	res.redirect(303,'/packinglistview?pl_number=PL0'+max_id+'&notdata[]='+not_data+'&count='+count)
	},5000);
}
else
{
...
if(id)
{
	...
	res.redirect(303,'/packinglistview?pl_number='+req.body.pl_number+'&notdata[]='+not_data+'&count='+count);
...
app.get('/removeplitem', requireLogin, function(req, res, next) { // route for '/'
	...
	dbs.update();
   res.redirect(303,'/packinglistedit?pl_num='+req.query.pl_name+'&notdata[]='+not_data+'&count='+count);
});
...
if(id)
{
	...
	setTimeout(function () {
         res.redirect(303,'/packinglistview?pl_number='+pl_num+'&notdata[]='+not_data+'&count='+count);
        }, 5000);
}
else
{
...
search.run(rest_params, function (err, results) {
  ...
  var status_ack=results.ackstatus;
	...
	setTimeout(function () {
           res.redirect(303,'/poview?record_type=PurchaseOrder&po_ns_id='+po_id+'&notdata[]='+not_data+'&count='+count);
        }, 3000);
