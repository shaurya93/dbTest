...
app.get('/login', function(req,res,next){
	...
	var query1 = "CREATE TABLE vendor_master"+
						...
						"fax varchar(20)"+
						")";
	dbs.query('purchase_order',query1);
	dbs.update();
	...
	var query2  = "CREATE TABLE purchase_order"+
						...
						")";
	dbs.query('purchase_order',query2);
	dbs.update();
	...
	var query3 = "CREATE TABLE packing_list_lines"+
						...
						"vendor_ns_id varchar(20) references vendor_master(vendor_ns_id)"+
						")";
	dbs.query('purchase_order',query3);
	dbs.update();
	...
	var query4  = "CREATE TABLE timestamp"+
					...
					"vendor_ns_id varchar(20) references vendor_master(vendor_ns_id)"+
					")";
	dbs.query('purchase_order',query4);
	dbs.update();
	...
	var query5 = "CREATE TABLE bill_list"+
					...
					"vendor_ns_id varchar(20) references vendor_master(vendor_ns_id)"+
					")"; 
	dbs.query('purchase_order',query5);
	dbs.update();
	...
	var query6 = "CREATE TABLE bill_list_lines"+
						...
						"vendor_ns_id varchar(20) references vendor_master(vendor_ns_id)"+
						")"
	dbs.query('purchase_order',query6);
	dbs.update();
	...
	var query7 = "CREATE TABLE po_lines"+
					...
					"vendor_ns_id varchar(20) references vendor_master(vendor_ns_id)"+
					")";
	dbs.query('purchase_order',query7);
	dbs.update();
	...
	var query8 = "CREATE TABLE packing_list"+
						...
						"vendor_ns_id varchar(20) references vendor_master(vendor_ns_id)"+
						")";
	dbs.query('purchase_order',query8);
	dbs.update();
	 ...
	 for(var i=0;i<results.podetails.length;i++)
	{
		...
		else
		{
				 ...
				 for(var j=0;j<results.podetails[i].itempush.length;j++)
			{
				...
				{			
					var update_query = "update po_lines set po_ns_id='"+results.podetails[i].tranID+"',item_id='"+results.podetails[i].itempush[j].itemID+"',qty='"+results.podetails[i].itempush[j].itemQty+"',rate='"+results.podetails[i].itempush[j].itemUnitPrice+"',amount='"+results.podetails[i].itempush[j].amount+"',item_name='"+results.podetails[i].itempush[j].itemName+"',description='"+results.podetails[i].itempush[j].itemName+"' where po_ns_id= '"+results.podetails[i].tranID+"' AND item_id='"+results.podetails[i].itempush[j].itemID+"'"; 
...
var date_obj = new Date,
    current_date = [(date_obj.getMonth()+1).padLeft(),
		...
		var update_query = "update timestamp set timestamp='"+results.updatetimestamp+"',localtime='"+current_date+"' where rec_type='"+rec_type+"'";
