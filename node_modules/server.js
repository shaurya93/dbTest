...
if(id)
{
	...
	po_ns_id=req.query.po_ns_id;
	console.log("po_ns_id  "+po_ns_id);
	function calcdispqty(itemidval,result1,i)
	{
			...
			//console.log("Item being Inserted and qty dispt being checked" + item[i]);
				...
				item.item_id_val= result1[i].item_id;
				item.item_name_val = result1[i].item_name; 
				item.po_ns_id_val = result1[i].po_ns_id;
				item.description_val = result1[i].description;
				item.quantity_val = result1[i].qty;
				//items_data.push(item);			
			});
			setTimeout(function(){
		...
		dbs.readData(function (result1){
			if(result1.length!=0)
			{
				...
				for (var i=0; i<result1.length; i++) 
				{
					...
					var item = new Object();
					items_data.push(calcdispqty(itemidval,result1,i));
