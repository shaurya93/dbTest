	...
	dbs.readData(function (result1){
		...
		if(result1!=null)
		{
			...
			for(var r=0;r<result1.length; r++) 
			{
				...
				item_receipt_line_list[r][0]=result1[r].bill_list_ns_id;
...
if(id)
{
	...
	search.run(rest_params, function (err, results) 
	{
		...
		if(pl_status=="Successful")
		{
			...
			var update_query = "update packing_list set STATUS ='Shipped' and packing_list_ns_id ="+ pl_ID +" where packing_list_num='" + pl_num
								+ "' AND vendor_ns_id='" + id + "'";
