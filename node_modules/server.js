...
/*
	var query10 = "Update timestamp set rec_type = 'Bills',timestamp='06/01/2016 10:15 PM',local_time='06/02/2016 10:45:16',vendor_ns_id='1413' where rec_type = 'Bills' and vendor_ns_id='1413'";
	var f10 = {query:query10};
	dbs.query(null,f10);
	dbs.update();
	
	var query12 = "ALTER TABLE bill_list_lines ALTER COLUMN description TYPE varchar" ;
   ...
   console.log('Results login::'+results);
	...
	if(results.status=='Successful')
	{
		...
		var update_query = "update vendor_master set email_id='" + results.Email
					...
					+ "',security_question='" + results.Security_ques
...
if(id)
{
	...
	var currency_val= parseJson(req.body.currency);
	console.log("Currency --> " + currency_val);	
	
	var terms_val= parseJson(req.body.terms);
	console.log("Terms --> " + terms_val);
	
	var incoterm_val= parseJson(req.body.incoterms);
	...
	var shipment_origin_val= parseJson(req.body.shipment_origin);
	...
	var security_question_val = parseJson(req.body.security_question);
	...
	var delivery_method_val = parseJson(req.body.delivery_method);
...
//var timestamp_contents = db.exec("select localtime from timestamp where rec_type= 'Bills'");
	...
	if(result != null)
	{
		...
		for (var i=0; i<result.length; i++) 
		{
			...
			date_create[i] = dt.date_formatter(result[i].bill_date);
