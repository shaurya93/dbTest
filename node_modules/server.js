...
app.get('/login', function(req,res,next){
	...
	var query10 = "Update timestamp set rec_type = 'PurchaseOrder',timestamp='06/01/2016 10:15 PM',local_time='06/02/2016 10:45:16',vendor_ns_id='3418' where rec_type = 'PurchaseOrder' and vendor_ns_id='3418'";
	...
	/*
		...
		*/
		...
		if(req.body.contact_number)
		{
			...
			if(req.body.address_line1||req.body.address_line2||req.body.city||req.body.region||req.body.postal_code||req.body.country)
		{
			console.log("Address --> " + req.body.address_line1 + "\n" + req.body.address_line2 +"\n" + req.body.city + "\n" + req.body.region + "\n" + req.body.country + "\n" + req.body.postal_code );
...
// insert or update PO and PO lines
	 for(var i=0;i<results.podetails.length;i++)
	{
		...
		var ack_check=results.podetails[i].ack_check;
			...
			if(results.podetails[i].total==null)
			{
				var total = 0;
			...
			if(results.podetails[i].taxtotal==null)
			{
				var taxtotal = 0;
			...
			if(results.podetails[i].exfact==null)
			{
				var exfact = null;
				console.log("Tax Total if null :: " + exfact);
			}
			else 
			{
				exfact ="'" + results.podetails[i].exfact + "'";
			}
			if(results.podetails[i].wharrival==null)
			{
				var wharrival = null;
				console.log("Tax Total if null :: " + wharrival);
			}
			else 
			{
				 ...
				 for(var j=0;j<results.podetails[i].itempush.length;j++)
			{
				...
				if(!is_exist)
				{
					var insert_query = "insert into po_lines values('"
								...
								+ results.podetails[i].tranID + "','"
								+ results.podetails[i].itemDescription + "','"
								...
								+ results.podetails[i].itempush[j].taxamount + "','"
								+ id + "')"; 
				...
				{			
					var update_query = "update po_lines set po_ns_id='" + results.podetails[i].tranID
								...
								+ "',tax_amount='" + results.podetails[i].itempush[j].taxamount
								+ "' where po_ns_id= '" + results.podetails[i].tranID
