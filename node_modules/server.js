...
app.post('/signup',function(req,res){
	...
	var isperson_val = null;
		...
		if(req.query.contact_number)
		{
			...
			if(req.query.address_line1||req.query.address_line2||req.query.city||req.query.region||req.query.postal_code||req.query.country)
		{
		//	console.log("Address --> " + req.query.address_line1 + "\n" + req.query.address_line2 +"\n" + req.query.city + "\n" + req.query.region + "\n" + req.query.country + "\n" + req.query.postal_code );
			address_val = req.query.address_line1 + "\n" + req.query.address_line2 +"\n" + req.query.city + "\n" + req.query.region + "\n" + req.query.country + "\n" + req.query.postal_code;
		}
		...
		console.log("Password -->" + req.query.password);
		console.log("Password -->" + password_val);
		if(req.query.alternate_contact_number)
		{
			console.log("Alt-Phone -->" + req.query.alternate_contact_number);
			console.log("Alt-Phone -->" + altphone_val);
		}
		if(req.query.faxno)
		{
			console.log("Fax -->" + req.query.faxno);
			...
			for(var j=0;j<results.billdetails[i].itempush.length;j++)
			{
				...
				if(!is_exist)
				{
						...
						var insert_query = "insert into bill_list_lines values('"
									...
									+ total_amount + "','"
									+ results.billdetails[i].itempush[j].grosswt + "','"
									+ results.billdetails[i].itempush[j].poNumber + "','"
									+ id + "')";
	...
	*/	
	...
	dbs.readData(function (result){
		...
		for (var i=0; i<result.length; i++) 
		{
			...
			poChild.push({name:"Packing List",assigned:"Packing List::"+pl_id[i],href:"https://supplier-portal.herokuapp.com/packinglistview?pl_number="+pl_number[i],date:pl_date[i],status:pl_status[i]});
	...
	dbs.readData(function (result){
		...
		for (var i=0; i<result.length; i++) 
		{
			...
			poChild.push({name:"Item Receipt",assigned:"Item Receipt::"+ir_id[i],href:"https://supplier-portal.herokuapp.com/ItemReceiptsView?ns_id="+ir_id[i],date:ir_date[i]});
	...
	var fields_VendorBillContents= {key:"po_id::integer",operator:"=",value:po_id,key1:"VENDOR_NS_ID::integer",operator1:"=",value1:id};
	...
	dbs.readData(function (result){
	 ...
	 setTimeout(function () {
		 poParent = {name:"Purchase Order",assigned:"Purchase Order::"+po_number,href:"https://supplier-portal.herokuapp.com/poview?po_ns_id="+po_id,children:poChild};
			console.log("after poParent : "+poParent);
