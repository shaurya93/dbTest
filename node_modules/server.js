...
if(id)
{
	...
	{
		var fields_plstatus_details= {key:"STATUS",operator:"=",value:pl_status,key1:"VENDOR_NS_ID::integer",operator1:"=",value1:id};
		...
		dbs.readData(function (result1){
			if(result1!=null)
			{
				...
				for (var i=0; result1.length; i++) 
				{
					...
					var fields_pl_lines = {key:"PO_NS_ID",operator:"=",value:po_ns_id,key1:"VENDOR_NS_ID::integer",operator1:"=",value1:id,key2:"ITEM_ID",operator2:"=",value2:item.item_id_val}
...
if(id)
{
	...
	var insert_query = "insert into packing_list('SHIP_TO','SHIP_DATE','DELIVERY_METHOD','SHIPMENT_ORIGIN','SHIPMENT_POINT','STATUS','packing_list_num','po_num','DATE_CREATED','MEMO','po_ns_id','vendor_ns_id') values('"
				+ req.body.shipto + "','"
				+ req.body.shipdate + "','"
				+ req.body.deliverymethod + "','"
				+ req.body.shipmentorigin + "','"
				+ req.body.shipmentpoint + "', 'Ready to Ship','PL"
				+ req.body.po_num + "','"
				+ req.body.po_num + "','"
