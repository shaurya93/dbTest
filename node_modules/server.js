...
{
	setTimeout(function () {
           res.redirect(303,'/billpaymentsview?bill_payment_ns_id='+bill_payment_ns_id);
        }, 5000);
...
if(id)
{
		...
		*/
		...
		var fields_item_receipt_details= {key:"ns_id",operator:"=",value:bill_payment_ns_id,key1:"VENDOR_NS_ID::integer",operator1:"=",value1:id};
		dbs.query('bill_payment',fields_item_receipt_details);
		dbs.readData(function (result1){
			...
			for (var i=0; i<result1.length; i++) 
			{
				...
				{
					ns_ext_id[i] = result1[i].ns_ext_id;
				}
			
				transaction_number[i] = result1[i].transaction_number;
				payee[i] = result1[i].payee;
				amount[i] = result1[i].amount;
				currency[i] = result1[i].currency;
				created_date[i] = result1[i].created_date; 
				memo[i] = result1[i].memo;
				ns_id[i] = result1[i].ns_id;
			} 
		...
		*/
		...
		var fields_item_receipt_line_contents= {key:"bill_payment_id",operator:"=",value:bill_payment_ns_id,key1:"VENDOR_NS_ID::integer",operator1:"=",value1:id};
		dbs.query('bill_payment_lines',fields_item_receipt_line_contents);
		dbs.readData(function (result){
			...
			if(result!=null)
			{
				...
				item.date_due_val = result[i].date_due;
				item.payment_val = result[i].payment;
				item.disc_date_val = result[i].disc_date;
