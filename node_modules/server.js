...
if(id)
{
	...
	po_ns_id=req.query.po_ns_id;
	console.log("po_ns_id  "+po_ns_id);
	function calcdispqty(itemidval)
	{
			...
			var qty_dispt = 0 ;
			dbs.readData(function (result2){
			//console.log("Item being Inserted and qty dispt being checked" + item[i]);
				if(result2.length!=0)
				{
					console.log(" pl_lines length" + result2.length);
						
					//console.log("Item being Inserted and qty dispt being checked inside if" + item);
					qty_dispt = 0 ;
			...
			setTimeout(function(){
				console.log("Before the return statement " + qty_dispt);
			return qty_dispt ;
			},200);
	}
		...
		dbs.readData(function (result1){
			if(result1.length!=0)
			{
				...
				for (var i=0; i<result1.length; i++) 
				{
					...
					console.log("item.item_id_val  "+result1[i].item_id);
					var itemidval = "'" +result1[i].item_id + "'";
					qty_dispt[i] = calcdispqty(itemidval);
					setTimeout(function(){
					item.push(new Object());
					item[i].item_id_val= result1[i].item_id;
					item[i].item_name_val = result1[i].item_name; 
					item[i].po_ns_id_val = result1[i].po_ns_id;
					item[i].description_val = result1[i].description;
					item[i].quantity_val = result1[i].qty;
					item[i].disp_qty = qty_dispt[i] ;
					items_data.push(item);
					},1000);
					//var qty_val = item.quantity_val;
					...
					console.log("returned qty dispatched value :: " + qty_dispt);
