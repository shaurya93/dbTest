...
if(req.query.vendorid)
{
	...
	contents.on("row", function(row,result)
        {
        	result.addRow(row);
        	console.log('unstringified content : '+ result.rows);
        	contents = JSON.stringify(result.rows);
      		console.log('contents in dashboard: ' + contents+'first_name' + contents[0].["first_name"]);
