...
<script>
		...
		function validate_quantity(row)
		{
			...
			var t = JSON.parse(items_data);
			console.log("Parsed JSON t  -->" + t[index].disp_qty);
			var q = JSON.parse(items);
			console.log("Parsed JSON  q  -->" + q[index].disp_qty);
			console.log("items_data[index].disp_qty"+items_data[index].disp_qty);
