...
<body style="background-image:url(img10.png);" >
		 ...
		 <div class="navbar navbar-inverse navbar-fixed-top " style="padding-top:15px; padding-bottom:0px;" >
			...
			<a href="#" class="navbar-brand" style="font-size:22px; color:white; padding-left:70pt;">SUPPLIER PORTAL</a>
			...
			<div class="collapse navbar-collapse navHeaderCollapse">
			  ...
			  <ul class="nav navbar-nav navbar-left">
				...
				<ul class="nav" >
				   <li  style="background: rgb(142, 36, 170); font-size:15px;"><a href="https://suptest.herokuapp.com/postatusview?po_status=Pending Acknowledge">Pending Acknowledge</a></li>
				   <li  style="background: rgb(142, 36, 170); font-size:15px;"><a href="https://suptest.herokuapp.com/postatusview?po_status=Acknowledged">Acknowledged</a></li>
				   <li style="background: rgb(142, 36, 170);font-size:15px;"><a href="https://suptest.herokuapp.com/postatusview?po_status=Pending Delivery">Pending Delivery</a></li>
				 ...
				 <li class="drop">
				   <a style="color:white; background: rgb(142, 36, 170);" href="#" class="dropdown-toggle" data-toggle="dropdown" >Packing List</a>
				   <ul class="nav">
				   <li style="background: rgb(142, 36, 170); font-size:15px;"><a href="https://supplier-portal.herokuapp.com/packingliststatusview?status=Ready to Ship">Ready To Ship</a></li>
				   <li style="background: rgb(142, 36, 170);font-size:15px;"><a href="https://supplier-portal.herokuapp.com/packingliststatusview?status=Shipped">Shipped</a></li>
				  </ul>
				</li>
				...
				<li class="drop">
				   ...
				   <ul class="nav">
				   <li style="background: rgb(142, 36, 170);font-size:15px;"><a href="href="https://suptest.herokuapp.com/billlistview">Bills</a></li>
				   </ul>
				</li>
    ...
    <main style="background-image:url(img10.png); >
		...
		<div align="left">	
	<span id="spanclass" style="background-color:white;color:#0D47A1;" class="btn btn-default">Last Refresh:16/04/2016 2:18:00 AM</span></div>	
	...
	<form method='POST'>
			...
			<% } else { %>		
				<tr>
					<td colspan="8" style="font-size: 12pt; font-weight:bold; color: blue; text-align:right;"><a class="btn btn-primary btn-sm" href="https://supplier-portal.herokuapp.com/profileedit">Refresh</a> <input type="submit" class="btn btn-primary btn-sm" name="submit" value="Submit" onclick="setCount();" style="width:80pt;"> <a class="btn btn-primary btn-sm" href="https://supplier-portal.herokuapp.com/poview?po_ns_id=<%= po_nsid%>">Cancel</a></td>
				</tr>
				<tr>
			...
			<% } else { %>		
				<tr>
					<td colspan="8" style="font-size: 12pt; font-weight:bold; color: blue; text-align:right;"><a class="btn btn-primary btn-sm" href="https://supplier-portal.herokuapp.com/profileedit">Refresh</a> <input type="submit" class="btn btn-primary btn-sm" name="submit" value="Submit" onclick="setCount();" style="width:80pt; align-content:center;"> <a class="btn btn-primary btn-sm" href="https://supplier-portal.herokuapp.com/poview?po_ns_id=<%= po_nsid%>">Cancel</a></td>
				</tr>
				<% }%>
			</table>
			</form>
