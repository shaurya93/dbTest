...
<script>
		...
		function validate_quantity(row)
		{
			...
			var items_data ='<%-JSON.stringify(items)%>';
			console.log("items_data[index].disp_qty"+items[index].disp_qty);
			var current_disp_qty = document.getElementById("quantitydispatched"+index).value;
			console.log("current_disp_qty  " + current_disp_qty);
			var total_qty =parseInt(current_disp_qty)+parseInt(items[index].disp_qty);
			console.log("total_qty" + total_qty);
			ordered_qty = items[index].quantity_val;
			...
			if(total_qty>ordered_qty)
			{
				...
				document.getElementById("quantitydispatched"+index).value=parseInt(ordered_qty)- parseInt(items[index].disp_qty);
			}
