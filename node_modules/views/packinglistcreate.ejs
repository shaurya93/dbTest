...
<body style="background-image:url(img10.png); font-family: sans-serif;">
	...
	<form method='POST'>
			...
			<% } else { %>		
				<tr>
					<td colspan="8" style="font-size: 12pt; font-weight:bold; color: blue; text-align:right;"><a class="btn btn-primary btn-sm" href="https://supplier-portal.herokuapp.com/profileedit">Refresh</a> <input type="submit" class="btn btn-primary btn-sm" name="submit" value="Submit" onclick="setCount();"> <a class="btn btn-primary btn-sm" href="https://supplier-portal.herokuapp.com/poview?po_ns_id=<%= po_nsid%>">Cancel</a></td>
				</tr>
				<tr>
