...
<script>
		...
		function validate_quantity(row)
		{
			...
			var disp_qty = '<%=disp_qty%>';
			console.log("Parsed JSON items_data  -->" + '<%=disp_qty%>');
			var current_disp_qty = document.getElementById("quantitydispatched"+index).value;
			console.log("current_disp_qty  " + current_disp_qty);
			var total_qty =parseInt(current_disp_qty)+parseInt(disp_qty[index]);
			...
			if(total_qty>ordered_qty)
			{
				...
				document.getElementById("quantitydispatched"+index).value=parseInt(ordered_qty)- parseInt(disp_qty[index]);
			}
	...
	<!--<div  class="transparent" style="overflow:scroll;">-->
			...
			<% } else { %>		
				...
				<tr>
					...
					<td  valign="top" ><input  type="text" name="shipto" id="shipid" value="<%= ship_to%>" /></td>
					...
					<td  valign="top" ><input  type="text" name="shipmentorigin"  required/></td>
					<td  valign="top" ><input  type="text" name="shipmentpoint" /></td>
				...
				<table id="pl_items" class="display" cellspacing="0" width="100%">
					...
					<tbody>
						...
						<tr>
							...
							<td><input  type="text" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name="quantitydispatched<%= i%>" id="quantitydispatched<%= i%>" value="<%= (parseInt(items[i].quantity_val)-parseInt(disp_qty[i]))%>" onchange="validate_quantity(this)" required/></td>
