...
<body style="background-image:url(img10.png);" >
  ...
  <!-- Modal -->
  <div class="modal fade" id="myModal" role="dialog"  style="background-color:#8E24AA; height:250pt; width:300pt; ">
      ...
      <!--<div class="modal-content">-->
        ...
        <div class="modal-body" >
          <form role="form" method="POST" class="form-horizontal" style="width:280pt;align:center; padding-top:0pt; padding-bottom:0pt;">
            ...
            <button class="btn btn-primary btn-sm pull-left" type="submit" name="contact_submitted" value="Search";>Search</button>
