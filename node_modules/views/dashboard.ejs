...
<body>
			...
			<div class="container">
			  ...
			  <li style="background:#8E24AA;"><a href="http://127.0.0.1:3000/postatusview?po_status=allorder">All Orders</a></li>
               ...
               <li style="background:#8E24AA;"><a href="http://127.0.0.1:3000/changepassword?vendorid=<%= v_id%>">Change Password</a></li>
								...
								<span class="navbar-brand" style="float:right; color:black; padding:15px 25px;">Cognizant</span><img style="float:right;" src="img/theme/cognizant-logo.png">
							</div></li>
								</ul>	
							</div>						
						</div>
	...
	<main>
	    <div >
		   <div id="advert3" class="container-fluid navbar-inverse modul-bt-one" align="center">
			<h3>&nbsp;</h3>
		</div>
		<div id="advert3" align="left" style="background-image:url(img10.png); color:#0D47A1;">
                       
            <div id="banner" class="transparent" style="overflow:scroll; background-color:white;">
       <div class="row"></div>	  
	  ...
	  <div class="row" style=" font-size: 18pt; font-weight:bold; color:blue;">Search</div>
      	   
	  <table style="background-color:white; width:100%;">
	  <tr>
	 <form method="POST">
	<td> <div class="input-field col s12 m4 l1">
	<input id="your_searchid" type="text" class="validate" name="your_searchid">
	<label for="your_searchid" >Transaction Id</label>
	</div></td>
	<td><div class="col s12 m4 l3">
	<div class="mdl-selectfield">
     ...
     <td><div class="col s12 m4 l3">
	 <div >
					<p style="text-align:center;"><button class="btn btn-primary btn-sm" type="submit" name="contact_submitted" value="Search";>Search</button></p>
					</div>
	 </div></td>
	 </form>
...
<div class="row"></div>
  <div class=" container-fluid card-1 " style="background-color:white";>
		...
		<div class="row"></div>
		<div class=" container-fluid card-1" style="background-color:white;">
		<div class="row" style="font-size: 18pt; font-weight:bold;">Bills</div>
		 <div class="row">
