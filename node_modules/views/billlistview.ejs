						...
						<table >
						  ...
						  <li style="background: rgb(142, 36, 170);"><a href="https://suptest.herokuapp.com/billlistview">Bills</a></li>
									  ...
									  <li class="drop" style="padding: 0px 15px;">My Account
										<ul class="nav">
						  <li style="background: rgb(142, 36, 170);"><a href="https://suptest.herokuapp.com/profileview?vendorid=1413">View/Update Profile</a></li>
						  <li style="background: rgb(142, 36, 170);"><a href="https://suptest.herokuapp.com/changepassword?vendorid=1413">Change Password</a></li>
			...
			<div  class="card-1" style="overflow:scroll;background:white;">
				<table id="" class="ex1" cellspacing="0" width="100%">
					<tr>
						...
						<td style="font-size: 12pt; font-weight:bold; color: blue; text-align:right;"><a class="btn btn-primary btn-sm" href="https://suptest.herokuapp.com/refreshbills?bill_status=none">Refresh</a></td>
					</tr>
				</table>
				<table id="" class="display ex1" cellspacing="0" width="100%">
					...
					<tbody>
						  <% for(var i=0;i<contentlength;i++) { %>	
							<tr>
								<td><a style="color: blue;" href="https://suptest.herokuapp.com/billview?bill_ns_id=<%= tran_id[i]%>"><%=tran_id[i]%></a></td>
								<td><%=tran_date[i]%></td>
