					...
					<div class="container">
						<table >
							<tr>
								...
								<td width="55%">
									<ul class="nav">
									  <li class="drop"><a style="padding: 0px 15px;" href="https://suptest.herokuapp.com/dashboard?vendorid=1413">Home</a></li>
			...
			<div class="card-1" style="background-color:white; overflow:scroll;">
				<table id="" class="ex1" cellspacing="0" width="100%">
					<tr>
							...
							<td style="font-size: 12pt; font-weight:bold; color: blue; text-align:right;"><a class="btn btn-primary btn-sm" href="https://suptest.herokuapp.com/refresh?record_type=PurchaseOrder&po_status=<%= statuspo%>">Refresh</a></td>
					</tr>
				</table>
				<table id="" class="display ex1" cellspacing="0" width="100%" >
					...
					<tbody>
						 <% for(var i=0;i<contentlength;i++) { %>	
							<tr>
								<td><a style="color: blue;" href="https://suptest.herokuapp.com/poview?po_ns_id=<%= tran_id[i]%>"><%=tran_no[i]%></a></td>
								<td><%=tran_date[i]%></td>
								<td><%=tran_status[i]%></td>
