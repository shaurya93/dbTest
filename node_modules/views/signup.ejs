     ...
     <div class="form">
        ...
        <div class="group">
			<div style="display:none; position:relative" id="icontainer">
			   ...
			   <div class="group">
			      <input name="first_name" id="first_name" width="300px" type="text" required>
                  <label align="left">First Name</label>
				  <span class="bar"></span>
				</div>
					
	            <div class="group">   
							<input name="last_name" id="last_name" width="300px" type="text" required>
        ...
        <div class="group">
         <p>Country:
                   <select id="country" name="country" >
                    ...
                    <option value="American Samou">American Samou</option>
	    ...
	    <div class="group">	
			...
			<div class="col offset-s7 s5" align="center">
                            <!--<input type="submit" class="btn btn-primary btn-sm" name="submit" value="Submit" onclick="setCount();" style="width:80pt;">-->
                            <input type="submit" style="color:white; text-align:center;" class="btn waves-effect waves-light red darken-1" name="submit" value="Submit" type="submit" onclick="return Validate()">
