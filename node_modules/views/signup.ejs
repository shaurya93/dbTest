 ...
 <div data-x="center" data-hoffset="0" data-y="center" data-voffset="-50" data-customin="x:0;y:0;z:0;rotationX:90;rotationY:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:100;transformOrigin:50% 0%;" data-customout="x:0;y:0;z:400;rotationX:0;rotationY:0;rotationZ:0;scaleX:0;scaleY:0;skewX:0;skewY:0;opacity:0;transformPerspective:200;transformOrigin:50% 50%;" data-speed="300" data-start="70" data-easing="Back.easeInOut" data-endeasing="Back.easeInOut" data-endspeed="600" style="z-index: 11;" class="tp-caption mediumlarge_light_white customin customout hidden-xs">Supplier Portal Features</div>
  ...
  <div style="background-color:#e4e6e8;">
   ...
   <div class="container-fluid navbar-inverse modul-bt-one" align="left">
     ...
     <div class="form">
                <ul class="tab-group" class="nav nav-tabs">
        ...
        <div class="group">
			<div style="display:none; position:relative" id="icontainer">
			   ...
			   <div class="group">
			      <input name="first_name" width="300px" type="text" required>
                  <label align="left">First Name</label>
				  <span class="bar"></span>
				</div>
					
	            <div class="group">   
							<input name="last_name" width="300px" type="text" required>
		...
		<div class="group">
		    <div style="display:none;position:relative;" id="commonformContainer">
			    ...
			    <div id="contactnumber" class="group">
				      <input type="text" width="300px" name="contactnumbercom" pattern="[0-9+]{1}[0-9-\s]{2,}" title="+(country code)(contact number)">
					     <label align="left">Contact Number</label>
					     <span class="bar"></span>
				</div>
					
				<div id="altcontactnumber" class="group">
					     <input name="altcontactnumbercom" width="300px" type="text" pattern="[0-9+]{1}[0-9-\s]{2,}" title="+(country code)(contact number)" >
        ...
        <!-- address-line1 input-->
            <div class="group">
                <input id="address-line1" name="address-line1" width="300px" type="text" >
        ...
        <!-- address-line2 input-->
		<div class="group">
                <input id="address-line2" name="address-line2" width="300px" type="text" >
        ...
        <!-- postal-code input-->
		<div class="group">
                <input id="postal-code" name="postal-code" width="300px" type="text" >
        ...
        <div class="group">
         <p>Country:
                   <select id="country" name="country" >
                    ...
                    <option value="4">American Samou</option>
                    ...
                    <option value="44">Ceuta and Melilla</option>
                    ...
                    <option value="53">Congo, Republic of</option> 
                    <option value="54">Cooks Islands</option>
                    ...
                    <option value="119">Korea, Democratic People's Republic</option>
                    ...
                    <option value="147">Micronesia, Federal State of</option>
                    ...
                    <option value="182">Reunion Island</option> 
                    ...
                    <option value="198">Serbia and Montenegro (Deprecated)</option>
                    <option value="199">Seychelles</option>  
                    <option value="200">Sierra Leone</option>
                    <option value="201">Singapore</option>
                    <option value="202">Sint Maarten</option> 
                    <option value="203">Slovak Republic</option>
					...
					<option value="213">State of Palestine</option> 
		...
		<div class="group">
		 <input type="text" width="300px" name="faxno" pattern="[0-9+]{1}[0-9-\s]{2,}" title="+(country code)(area code)(fax number)">
                ...
                <div class="group">
					<p>Security Question:<select class="security" name="security">
				...
				<div class="group">
                            <input name="security_answer" width="300px" type="text" >
                            <label align="left">Answer</label>
							<span class="bar"></span>
                </div>
                <div class="group">
                            <input width="300px" id="pwd1"  type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                            <label align="left">Password</label>
							<span class="bar"></span>
			    </div>
				<div class="group">
                            <input width="300px" id="pwd2" type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                ...
                <div class="group">
					<p>Primary Currency:<select class="currency" name="currency" required >
			    ...
			    <div class="group">
					<p>Terms:<select class="terms" name="terms">
			    ...
			    <div class="group">
					<p>Incoterm:<select class="incoterms" name="incoterms">
				...
				<div class="group">
					<p>Delivery Methods:<select class="modes" name="modes">
			    ...
			    <div class="group">
					<p>Shipment Origin:<select class="shipment_origin" name="shipment_origin">
				...
				<div class="group">   
							<input name="deliveryleadtime" width="300px" type="number">
                            <label align="left">Delivery Lead Time(Days)</label>
							<span class="bar"></span>
			    </div>

				<div class="group">   
							<input name="exfactoryleadtime" width="300px" type="number">
	    ...
	    <div class="group">	
			<div style="display:none; position:relative;" id="supplierformContainer">
			  ...
			  <fieldset>
				...
				<div class="group">
				 <input type="text" width="300px" name="con_number" pattern="[0-9+]{1}[0-9-\s]{2,}" title="+(country code)(area code)(fax number)">
