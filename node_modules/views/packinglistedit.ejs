	...
	<form method='POST'  >
			<table  width="100%" border="0" style="font-family: Arial, Helvetica; font-size: 9pt; align-content: center; background: white;">
				<tr style="background-image:url(img10.png);">
					<td colspan="6" style="font-size: 12pt; font-weight:bold; color: blue; text-align:right;"><input type="submit" class="btn btn-primary btn-sm" name="save" value="Save" onclick="setCount();" style="width:80pt;"> <a class="btn btn-primary btn-sm" href="https://supplier-portal.herokuapp.com/packinglistview?pl_number=<%= pl_number%>">Cancel</a></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td  valign="top" ><input style="border:none; background: transparent; color:#505050;" type="text" name="deliverymethod" value="<%= delivery_method%>" readonly/></td>
					<td  valign="top" ><input style="border:none; background: transparent; color:#505050;" type="text" name="shipment_origin" value="<%= shipment_origin%>" readonly/></td>
					<td  valign="top" ><input style="border:none; background: transparent; color:#505050;" type="text" name="shipment_point" value="<%= shipment_point%>" readonly/></td>
					<td  valign="top" ><input style="border:none; background: transparent; color:#505050;" type="text" name="memo" value="<%= memo%>" readonly/></td>
				</tr>
			</table>
				...
				<table id="pl_items" class="display" cellspacing="0" width="100%" >
					...
					<tbody >
							...
							<tr>
								...
								<td><a style="color: blue;" href="https://supplier-portal.herokuapp.com/removeplitem?pl_name=<%= pl_number%>&item_id=<%= items[i].item_id_val %>">Remove</a></td>
							</tr>
							<% } } %>
					</tbody>
