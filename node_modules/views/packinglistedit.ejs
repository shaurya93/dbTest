...
<body style="background-image:url(img10.png); font-family: sans-serif;">
	...
	<form method='POST'>
			<table  width="100%" border="0" style="font-family: Arial, Helvetica; font-size: 9pt; align-content: center; background: white;">
				<tr>
					<td colspan="6" style="font-size: 12pt; font-weight:bold; color: blue; text-align:right;"><input type="submit" class="btn btn-primary btn-sm" name="save" value="Save" onclick="setCount();"> <a class="btn btn-primary btn-sm" href="https://supplier-portal.herokuapp.com/packinglistview?pl_number=<%= pl_number%>">Cancel</a></td>
				</tr>
				<tr>
