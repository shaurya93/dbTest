	...
	module.exports.read = function(){
		...
		client.connect();	
				...
				var contents_po_all_count= client.query("select * from "+this.table , function(err, result) {
      				...
      				console.log('rows pushed' + JSON.stringify(result.rows[0]));
      				query_result=JSON.stringify(contents_po_all_count);
      				console.log('result :: ' + result.rowCount);
      				//console.log("contents_po_all_count inside func"+JSON.stringify(contents_po_all_count));
    				console.log('Query_result before return :: ' + query_result.rowCount);
				return query_result;
				client.end();
				});
